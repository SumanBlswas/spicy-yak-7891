...
export const getProducts = (dispatch) => {
    ...
    axios.get(`https://maroon-sea-urchin-tam.cyclic.app/menproducts`).then((res) => { dispatch(getProductDataSuccess(res.data)) })
      .catch((err) => {
  ...
  export const addProduct = (product) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.post(
        "https://maroon-sea-urchin-tam.cyclic.app/menproducts/add",
        product
      );
  ...
  export const deleteProduct = (id) => async (dispatch) => {
    ...
    try {
      axios.delete(`https://maroon-sea-urchin-tam.cyclic.app/menproducts/delete/${id}`);
  ...
  export const updateProduct = (id,product) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.patch(
        `https://maroon-sea-urchin-tam.cyclic.app/menproducts/updates/${id}`,
        product
      );
