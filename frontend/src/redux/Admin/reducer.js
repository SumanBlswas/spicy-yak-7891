    ...
    switch (type) {
      ...
      case UPDATE_PRODUCT_SUCCESS:
        ...
        case DELETE_ADMIN_SUCCESS:
          return {...state,isLoadingAdminDelete: false,admins:state.admins.filter((admin) => admin._id !== payload)
          };
